...
export enum ChannelID {
    UC6LJZ9Ctx1VcmRY9CFEPyww = 'UC6lJZ9Ctx1vcmRY9cFEPyww',
}

export enum ChannelTitle {
    LaVidaModerna = 'La Vida Moderna',
}

export enum PlaylistID {
    UU6LJZ9Ctx1VcmRY9CFEPyww = 'UU6lJZ9Ctx1vcmRY9cFEPyww',
}
...
const typeMap: any = {
    ...
    'ChannelID': [
        'UC6lJZ9Ctx1vcmRY9cFEPyww',
    ],
    'ChannelTitle': [
        'La Vida Moderna',
    ],
    'PlaylistID': [
        'UU6lJZ9Ctx1vcmRY9cFEPyww',
    ],
    'ResourceIDKind': [
        'youtube#video',
    ],
